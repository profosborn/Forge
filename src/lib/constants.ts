...
import ForgeCategory from '@/components/icons/forge-category'
...
export const pricingCards = [
    {
      title: 'Starter',
      description: 'Ideal for experiencing Forge',
      price: 'Free',
      duration: '',
    ...
    },
    {
      ...
      priceId: 'price_1Os6urJQVdKbZ6Sf2x7EZr6m',
    },
    {
      title: 'Basic',
      description: 'For dedicated agency owners',
      price: '$49',
      duration: 'month',
      highlight: 'Everything in Starter, plus',
      features: ['Unlimited Sub accounts', 'Unlimited Team members'],
      priceId: 'price_1Os6uqJQVdKbZ6SfdyoocMfx',
    },
  ]

  export const addOnProducts = [
    { title: 'Priority Support', id: 'prod_PiZtLa8QmhS3Sn' },
  ]
